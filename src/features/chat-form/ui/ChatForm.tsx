      ...
      <FormProvider {...form}>
        <Form {...form}>
          ...
          >
            <div
              id={"messages"}
              className="flex items-center shadow-amber-950 shadow-2xl h-base-height max-h-80 overflow-auto gap-2 w-full bg-slate-50 rounded-lg px-1"
            >
            ...
            <div className="h-[56px] flex items-center justify-center self-end">
              <Button
                type="submit"
                variant="noShadow"
                className=" rounded-full p-0 aspect-square h-full"
              >
