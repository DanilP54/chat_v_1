...
import { DropdownMenuLabel, DropdownMenuSeparator, DropdownMenuGroup, DropdownMenuItem } from "@/shared/ui/dropdown-menu"
      ...
      <DropdownMenuGroup>
        <nav>
          <DropdownMenuItem className="cursor-pointer hover:bg-gray-300">
            <Link to={'/profile'} className="text-base flex items-center gap-1 ">
              <User size={ICON_SIZE} className="mr-2" />
              Profile
            </Link>
          </DropdownMenuItem>
          <DropdownMenuItem className="cursor-pointer hover:bg-gray-300">
            <Link to={'/settings'} className="text-base flex items-center gap-1">
